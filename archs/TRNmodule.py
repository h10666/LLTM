...
class RelationModuleMultiScale(torch.nn.Module):
    ...
    def forward(self, input):
        ...
        # print('self.relations_scales[0][0]:\t', self.relations_scales[0][0])
        act_all = input[:, self.relations_scales[0][0] , :]

        # print('act_all:\t', act_all.size())
        # print('self.scales[0]:\t', self.scales[0])
        # print('act_all.size(0):\t', act_all.size(0))
